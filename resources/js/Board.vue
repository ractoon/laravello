<template>
  <div class="h-full flex flex-col items-stretch" :class="bgColor">
    <div class="header text-white flex justify-between items-center mb-2">
      ...
      <div class="ml-2 w-1/3 flex justify-end">
    ...
    <div class="h-full flex flex-1 flex-col items-stretch">
      ...
      <div class="flex flex-1 items-start overflow-x-auto mx-2" v-if="board">
        ...
        />
        <ListAddEditor :board="board.id" @added="updateQueryCache($event)" />
      </div>
    </div>
  </div>
</template>
...
<script>
import { EVENT_CARD_ADDED, EVENT_CARD_UPDATED, EVENT_CARD_DELETED, EVENT_LIST_ADDED } from './constants';
